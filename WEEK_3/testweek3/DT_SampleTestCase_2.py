...
def test_case():
    ...
    print('Sky entropy : ',np.isclose(0.9509775004326937,get_avg_info_of_attribute(df, 'Sky'))) #0.9509775004326937
    print('Sky IG : ', np.isclose(0.01997309402197489, get_information_gain(df, 'Sky'))) #0.01997309402197489
    print('Airtemp entropy : ',np.isclose(0.6490224995673063, get_avg_info_of_attribute(df, 'Airtemp'))) #0.6490224995673063
    print('Airtemp IG : ', np.isclose(0.3219280948873623, get_information_gain(df, 'Airtemp'))) #0.3219280948873623
    print('Humidity entropy : ',np.isclose(0.9509775004326937, get_avg_info_of_attribute(df, 'Humidity'))) #0.9509775004326937
    print('Humidity IG : ', np.isclose(0.01997309402197489, get_information_gain(df, 'Humidity'))) #0.01997309402197489
    print('Water entropy : ',np.isclose(0.8, get_avg_info_of_attribute(df, 'Water'))) #0.8
    print('Water IG : ', np.isclose(0.17095059445466854,get_information_gain(df, 'Water'))) #0.17095059445466854
    print('Forecast entropy : ',np.isclose(0.9509775004326937, get_avg_info_of_attribute(df, 'Forecast'))) #0.9509775004326937
    ...
    print('Age entropy : ', np.isclose(0.6324823551623816, get_avg_info_of_attribute(df, 'Age'))) #0.6324823551623816
    print('Age IG : ', np.isclose(0.30780360350824953, get_information_gain(df, 'Age'))) #0.30780360350824953
    print('Income entropy : ', np.isclose(0.9110633930116763, get_avg_info_of_attribute(df, 'Income'))) #0.9110633930116763
    print('Income IG : ', np.isclose(0.02922256565895487, get_information_gain(df, 'Income'))) #0.02922256565895487
    print('Student entropy : ', np.isclose(0.7884504573082896, get_avg_info_of_attribute(df, 'Student'))) #0.7884504573082896
    print('Student IG : ', np.isclose(0.15183550136234159, get_information_gain(df, 'Student'))) #0.15183550136234159
    print('Credit_rating entropy : ', np.isclose(0.8921589282623617, get_avg_info_of_attribute(df, 'Credit_rating'))) #0.8921589282623617
    ...
    print('Salary entropy : ', np.isclose(0.5156629249195446, get_avg_info_of_attribute(df,'salary'))) #0.5156629249195446
    print('Salary IG : ', np.isclose(0.46956521111470695, get_information_gain(df,'salary'))) #0.46956521111470695
    print('Location entropy : ', np.isclose(0.2857142857142857, get_avg_info_of_attribute(df,'location'))) #0.2857142857142857
    ...
    print('Dataset entropy : ', np.isclose(0.9709505944546686, get_entropy_of_dataset(df))) #0.9709505944546686
    print('Toothed entropy : ', np.isclose(0.963547202339972, get_avg_info_of_attribute(df,'toothed'))) #0.963547202339972
    print('Toothed IG : ', np.isclose(0.007403392114696539, get_information_gain(df,'toothed'))) #0.007403392114696539
    print('Breathes entropy : ', np.isclose(0.8264662506490407, get_avg_info_of_attribute(df,'breathes'))) #0.8264662506490407
    print('Breathes IG : ', np.isclose(0.1444843438056279, get_information_gain(df,'breathes'))) #0.1444843438056279
    print('Legs entropy : ', np.isclose(0.4141709450076292, get_avg_info_of_attribute(df,'legs'))) #0.4141709450076292
    ...
    print("Entropy of category attribute:", np.isclose(get_avg_info_of_attribute(df, "category"), 0.9182958340544896))
    ...
    print("Color entropy: ", np.isclose(get_avg_info_of_attribute(df, 'color'),0.9709505944546686))
    print("Color IG:", np.isclose(0.0, get_information_gain(df, 'color')))
    print("Size entropy:", np.isclose(0.9709505944546686, get_avg_info_of_attribute(df, 'size')))
    print("Size IG:", np.isclose(0.0, get_information_gain(df, 'size')))
    print("act entropy:",np.isclose(get_avg_info_of_attribute(df, 'act'),0.5509775004326937))
    print("Act IG: ",np.isclose(0.4199730940219749, get_information_gain(df, 'act')))
    print("age Entropy:", np.isclose(0.5509775004326937, get_avg_info_of_attribute(df, 'age')))
    ...
    print("caprice Entropy:", np.isclose(get_avg_info_of_attribute(df, 'caprice'),1.2921917219486119))
    print("caprice IG:", np.isclose(get_information_gain(df, 'caprice'),0.14667115309328205))
    print("topic Entropy:", np.isclose(get_avg_info_of_attribute(df, 'topic'),1.0883213898497568))
    print("topic IG:", np.isclose(get_information_gain(df, 'topic'),0.3505414851921371))
    print("lmt Entropy:", np.isclose(get_avg_info_of_attribute(df, 'lmt'),1.4134166106032882))
    print("lmt IG:", np.isclose(get_information_gain(df, 'lmt'),0.02544626443860576))
    print("lpss Entropy:", np.isclose(get_avg_info_of_attribute(df, 'lpss'),1.3920622169341164))
    print("lpss IG:", np.isclose(get_information_gain(df, 'lpss'),0.04680065810777756))
    print("pb Entropy:", np.isclose(get_avg_info_of_attribute(df, 'pb'),1.3591269643656734))
